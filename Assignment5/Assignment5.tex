...
\begin{lemma}
Generating function for $W = \abs{X-Y}$ where $\mathcal{G}_{X}(z) =\dfrac{1+z}{2}$ and $\mathcal{G}_{Y}(z) = \dfrac{1+z}{2}$ is $$\mathcal{G}_W(z) = \frac{1+z}{2}$$
\end{lemma}
\begin{proof}
 \begin{align}
...
\end{multline}
\begin{align}
    &= \frac{1}{4}z^1 + \frac{1}{4}z^1+\left(\frac{1}{4}z^0 + \frac{1}{4}z^0\right)
\end{align}
($\because$ Only possibility for $(X,Y)$ such that $X>Y$ is (1,0); Similarly for $Y>X$ and for $X=Y$, two possibilities, (0,0),(1,1))
\begin{align}
  &= \frac{1+z}{2}
\end{align}
\end{proof}
\begin{definition}
The pmf of $W$ with $\mathcal{G}_W(z) = \dfrac{1+z}{2}$ is
\begin{equation}
   \pr{W=w} =
    \begin{cases}
...
\end{align}
\begin{definition}
The pmf of $Z$ with $\mathcal{G}_Z(z)= \dfrac{1}{4} + \dfrac{1}{2}z + \dfrac{1}{4}z^2$ is
\begin{align}
    \pr{Z = z} = 
\begin{cases}
\frac{1}{4} & z=0
