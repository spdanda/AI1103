...
\begin{align}
   \text{Also }E[W] &= 0\times\frac{1}{2} + 1\times\frac{1}{2}\\
                    &= \frac{1}{2} 
\end{align}
 \item Characteristic function of random variable is defined as
\begin{align}
\phi_X(\omega)=E[e^{iwX}] \label{simul1}
\end{align}
For discrete random variable X
\begin{align}
   \phi_X(\omega) =\sum_{k}e^{iwk}P_X(k)\\
\phi_X(\omega)=\frac{1 + e^{iw}}{2}
\end{align}
Similarly, For discrete random variable Y
\begin{align}
\phi_Y(\omega) = \sum_{k}e^{iwk}P_Y(k)\\
\phi_Y(\omega)= \frac{1 + e^{iw}}{2}
\end{align}
...
\end{align}
\begin{align}
  \phi_{Z}(\omega) &=\left(\frac{1 + e^{iw}}{2}\right)^2\\
                   &= \frac{1+e^{2iw}+2e^{iw}}{4}\\
                   &= \frac{1}{4}\,e^{0iw} + \frac{1}{2}e^{iw} + \frac{1}{4}e^{2iw}
\end{align}
From the definition of characteristic function of a discrete random variable as in \eqref{simul1}, we get\\
    PMF of Z is 
\begin{align}
    p_{Z}(z) = \pr{Z = z} = 
\begin{cases}
